...
* @module Meadow
*/
const n=e=>{let t="=";switch(e){case"EQ":t="=";break;case"NE":t="!=";break;case"GT":t=">";break;case"GE":t=">=";break;case"LT":t="<";break;case"LE":t="<=";break;case"LK":t="LIKE";break;case"NLK":t="NOT LIKE";break;case"IN":t="IS NULL";break;case"NN":t="IS NOT NULL";break;case"INN":t="IN";break;case"NIN":t="NOT IN";break;case"FOP":case"FOPOR":t="(";break;case"FCP":t=")"}return t},o=e=>{const t=e.Field.indexOf("$");let r,n;if(-1!==t)r=e.Field.substring(0,t),n=e.Field.substring(t+1);else{const t=e.Field.indexOf(".");if(t<1){const t=`Invalid format for Field[${e.Field}]`;throw new Error(t)}r=e.Field.substring(0,t),n=e.Field.substring(t)}let[o,a]=[r,n].map(e=>e.replace(/'/g,"\\'").replace(/"/g,'\\"'));return{fieldColumn:o,jsonPath:a}},a=(e,t,r,n,o,a)=>{a.addFilter("","","(",o),a.addFilter(`JSON_VALID(${e})`,1,"=","AND","validJson");let i=`CAST(JSON_UNQUOTE(JSON_EXTRACT(${e}, '$${t}')) AS CHAR)`,u=r;if(Array.isArray(r)){r.find(e=>isNaN(Number(e)))||(u=r.map(e=>Number(e)))}else isNaN(Number(r))||(u=Number(r));return a.addFilter(i,u,n,"AND","jsonExtracted"),a.addFilter("","",")"),a},i=(e,t)=>{if(!e.Instruction)return!1;switch(e.Instruction){case"FBV":t.addFilter(e.Field,e.Value,n(e.Operator),"AND");break;case"FBVOR":t.addFilter(e.Field,e.Value,n(e.Operator),"OR");break;case"FBL":t.addFilter(e.Field,e.Value.split(","),n(e.Operator),"AND");break;case"FBLOR":t.addFilter(e.Field,e.Value.split(","),n(e.Operator),"OR");break;case"FBD":t.addFilter(`DATE(${e.Field})`,e.Value.split(","),n(e.Operator),"AND",e.Field);break;case"FBDOR":t.addFilter(`DATE(${e.Field})`,e.Value.split(","),n(e.Operator),"OR",e.Field);break;case"FSF":const r="DESC"===e.Operator?"Descending":"Ascending";t.addSort({Column:e.Field,Direction:r});break;case"FBJV":{const{fieldColumn:r,jsonPath:i}=o(e);a(r,i,e.Value,n(e.Operator),"AND",t);break}case"FBJVOR":{const{fieldColumn:r,jsonPath:i}=o(e);a(r,i,e.Value,n(e.Operator),"OR",t);break}case"FBJL":{const{fieldColumn:r,jsonPath:i}=o(e);a(r,i,e.Value.split(","),n(e.Operator),"AND",t);break}case"FBJLOR":{const{fieldColumn:r,jsonPath:i}=o(e);a(r,i,e.Value.split(","),n(e.Operator),"OR",t);break}case"FBJD":{const{fieldColumn:r,jsonPath:a}=o(e);t.addFilter("","","("),t.addFilter(`JSON_VALID(${r})`,1,"=","AND","validJson"),t.addFilter(`DATE(JSON_UNQUOTE(JSON_EXTRACT(${r}, '$${a}')))`,e.Value.split(","),n(e.Operator),"AND",r),t.addFilter("","",")");break}case"FSJF":{const{fieldColumn:r,jsonPath:n}=o(e),a="DESC"===e.Operator?"Descending":"Ascending",i=(e=>{let t="CHAR";switch(e){case"SINT":t="SIGNED";break;case"UINT":t="UNSIGNED";break;case"DD":t="DECIMAL(10,5)";break;case"DATE":t="DATE"}return t})(e.Value);t.addFilter(`JSON_VALID(${r})`,1,"=","AND","validJson"),t.addSort({Column:`CAST(${r} ->> '$${n}' AS ${i})`,Direction:a});break}case"FOP":t.addFilter("","","(");break;case"FOPOR":t.addFilter("","","(","OR");break;case"FCP":t.addFilter("","",")");break;case"FDST":t.setDistinct&&t.setDistinct(!0);break;default:return!1}return e.Instruction=!1,!0};t.exports=(e,t)=>{if("string"!=typeof e)return!1;const r=e.split("~");if(r.length<4)return!0;let n={Instruction:null};for(let e=0;e<r.length;e++)switch(e%4){case 0:i(n,t),n={Instruction:r[e],Field:"",Operator:"",Value:""};break;case 1:n.Field=r[e];break;case 2:n.Operator=r[e];break;case 3:n.Value=r[e]}return i(n,t),!0}},{}],98:[function(e,t,r){t.exports={parse:e("./Meadow-Filter-Parse.js")}},{"./Meadow-Filter-Parse.js":97}],99:[function(e,t,r){t.exports=function(t,r){var n=!1;try{n=e(r)}catch(e){return t.fable.log.error("Error loading Fable package",{Package:r}),!1}var o=t.new(t.fable);return"string"==typeof n.Scope&&o.setScope(n.Scope),"string"==typeof n.Domain&&o.setDomain(n.Domain),"string"==typeof n.DefaultIdentifier&&o.setDefaultIdentifier(n.DefaultIdentifier),Array.isArray(n.Schema)&&o.setSchema(n.Schema),"object"==typeof n.JsonSchema&&o.setJsonSchema(n.JsonSchema),"object"==typeof n.DefaultObject&&o.setDefault(n.DefaultObject),"object"==typeof n.Authorization&&o.setAuthorizer(n.Authorization),o}},{}],100:[function(e,t,r){t.exports=function(e,t){var r="object"==typeof t?t:{};t.hasOwnProperty("Scope")||e.fable.log.error("Error loading Fable package -- scope not defined.",{Package:t});var n=e.new(e.fable);return"string"==typeof r.Scope&&n.setScope(r.Scope),"string"==typeof r.Domain&&n.setDomain(r.Domain),"string"==typeof r.DefaultIdentifier&&n.setDefaultIdentifier(r.DefaultIdentifier),Array.isArray(r.Schema)&&n.setSchema(r.Schema),"object"==typeof r.JsonSchema&&n.setJsonSchema(r.JsonSchema),"object"==typeof r.DefaultObject&&n.setDefault(r.DefaultObject),"object"==typeof r.Authorization&&n.setAuthorizer(r.Authorization),n}},{}],101:[function(e,t,r){
/**
* @license MIT
...
* @author <steven@velozo.com>
*/
var n=e("is-my-json-valid");t.exports=new function(){return function e(t,r){var o=!1,a=!1,i=!1,u=!1,s={},l=function(e){o="object"==typeof e?e:{title:"Unknown",type:"object",required:[]}};l(r);var c=function(e){u=n(a="object"==typeof e?e:{title:"Unknown",type:"object",required:[]},{greedy:!0,verbose:!0})};c(t);var f=function(e){i="object"==typeof e?e:{}};f();var d={setSchema:l,setJsonSchema:c,setDefault:f,setAuthorizer:function(e){s="object"==typeof e?e:{}},validateObject:function(e){var t={Valid:u(e)};return t.Valid||(t.Errors=u.errors),t},new:e};return Object.defineProperty(d,"schema",{get:function(){return o},enumerable:!0}),Object.defineProperty(d,"jsonSchema",{get:function(){return a},enumerable:!0}),Object.defineProperty(d,"defaultObject",{get:function(){return i},enumerable:!0}),Object.defineProperty(d,"authorizer",{get:function(){return s},enumerable:!0}),d}()}},{"is-my-json-valid":83}],103:[function(e,t,r){
/**
* @license MIT
* @author <steven@velozo.com>
*/
var n=e("foxhound");t.exports=new function(){return function t(r,o,a,i){if("object"!=typeof r||!("fable"in r))return{new:t};var u=r;u.settingsManager.fill({MeadowProvider:"None"});var s=0,l="string"==typeof o?o:"Unknown",c=e("./Meadow-Schema.js").new(a,i),f=n.new(u).setScope(l),d=e("./Meadow-RawQuery.js").new(u),p=e("./behaviors/Meadow-Create.js"),h=e("./behaviors/Meadow-Read.js"),y=e("./behaviors/Meadow-Reads.js"),g=e("./behaviors/Meadow-Update.js"),b=e("./behaviors/Meadow-Delete.js"),m=e("./behaviors/Meadow-Undelete.js"),v=e("./behaviors/Meadow-Count.js"),w=!1,S=!1,D="ID"+l,A="GUID"+l,O=e("./Meadow-PackageFileLoader.js"),E=e("./Meadow-PackageObjectLoader.js"),_=()=>("function"==typeof w.setSchema&&w.setSchema(l,c.schema,D,A),this),C={ALASQL:e("./providers/Meadow-Provider-ALASQL.js"),MeadowEndpoints:e("./providers/Meadow-Provider-MeadowEndpoints.js"),MySQL:e("./providers/Meadow-Provider-MySQL.js"),MSSQL:e("./providers/Meadow-Provider-MSSQL.js"),SQLite:e("./providers/Meadow-Provider-SQLite.js"),PostgreSQL:e("./providers/Meadow-Provider-PostgreSQL.js"),MongoDB:e("./providers/Meadow-Provider-MongoDB.js"),DGraph:e("./providers/Meadow-Provider-DGraph.js"),Solr:e("./providers/Meadow-Provider-Solr.js"),RocksDB:e("./providers/Meadow-Provider-RocksDB.js"),None:e("./providers/Meadow-Provider-None.js")},R=function(e){"string"!=typeof e&&(e="None");try{w=C[e].new(u),_(),S=e}catch(t){u.log.error("Provider not set - require load problem",{InvalidProvider:e,error:t}),R("None")}return this};let q;R(u.settings.MeadowProvider),q=Array.isArray(u.settings.MeadowRoleNames)?u.settings.MeadowRoleNames:["Unauthenticated","User","Manager","Director","Executive","Administrator"];var T={doCreate:function(e,t){return p(this,e,t)},doRead:function(e,t){return h(this,e,t)},doReads:function(e,t){return y(this,e,t)},doUpdate:function(e,t){return g(this,e,t)},doDelete:function(e,t){return b(this,e,t)},doUndelete:function(e,t){return m(this,e,t)},doCount:function(e,t){return v(this,e,t)},validateObject:c.validateObject,marshalRecordFromSourceToObject:function(e){var t=u.Utility.extend({},c.defaultObject);return w.marshalRecordFromSourceToObject(t,e,c.schema),t},setProvider:R,setIDUser:function(e){return s=e,this},loadFromPackage:function(e){return O(this,e)},loadFromPackageObject:function(e){return E(this,e)},setScope:function(e){return l=e,f.setScope(e),_(),this},setDomain:function(e){return this},setSchema:function(e){return c.setSchema(e),_(),this},setJsonSchema:function(e){return c.setJsonSchema(e),this},setDefault:function(e){return c.setDefault(e),this},setDefaultIdentifier:function(e){return D=e,A="GU"+e,_(),this},setAuthorizer:function(e){return c.setAuthorizer(e),this},getRoleName:function(e){return e<0||e>=q.length?"Unauthenticated":q[e]},logSlowQuery:function(e,t){var r=t.query||{body:"",parameters:{}},n=r.body;if(r.parameters.length)for(var o in r.parameters)n=n.replace(":"+o,r.parameters[o]);u.log.warn("Slow Read query took "+e+"ms",{Provider:S,Query:{Body:r.body,Parameters:r.parameters,FullQuery:n}})},new:t};return Object.defineProperty(T,"scope",{get:function(){return l},enumerable:!0}),Object.defineProperty(T,"schema",{get:function(){return c.schema},enumerable:!0}),Object.defineProperty(T,"schemaFull",{get:function(){return c},enumerable:!0}),Object.defineProperty(T,"defaultIdentifier",{get:function(){return D},enumerable:!0}),Object.defineProperty(T,"defaultGUIdentifier",{get:function(){return A},enumerable:!0}),Object.defineProperty(T,"jsonSchema",{get:function(){return c.jsonSchema},enumerable:!0}),Object.defineProperty(T,"userIdentifier",{get:function(){return s},enumerable:!0}),Object.defineProperty(T,"query",{get:function(){var e=f.clone();return e.query.schema=c.schema,e},enumerable:!0}),Object.defineProperty(T,"rawQueries",{get:function(){return d},enumerable:!0}),Object.defineProperty(T,"provider",{get:function(){return w},enumerable:!0}),Object.defineProperty(T,"providerName",{get:function(){return S},enumerable:!0}),"function"==typeof u.addServices?u.addServices(T):(Object.defineProperty(T,"fable",{get:function(){return u},enumerable:!1}),Object.defineProperty(T,"settings",{get:function(){return u.settings},enumerable:!1}),Object.defineProperty(T,"log",{get:function(){return u.log},enumerable:!1})),T}()}},{"./Meadow-PackageFileLoader.js":99,"./Meadow-PackageObjectLoader.js":100,"./Meadow-RawQuery.js":101,"./Meadow-Schema.js":102,"./behaviors/Meadow-Count.js":104,"./behaviors/Meadow-Create.js":105,"./behaviors/Meadow-Delete.js":106,"./behaviors/Meadow-Read.js":107,"./behaviors/Meadow-Reads.js":108,"./behaviors/Meadow-Undelete.js":109,"./behaviors/Meadow-Update.js":110,"./providers/Meadow-Provider-ALASQL.js":111,"./providers/Meadow-Provider-DGraph.js":112,"./providers/Meadow-Provider-MSSQL.js":113,"./providers/Meadow-Provider-MeadowEndpoints.js":114,"./providers/Meadow-Provider-MongoDB.js":115,"./providers/Meadow-Provider-MySQL.js":116,"./providers/Meadow-Provider-None.js":117,"./providers/Meadow-Provider-PostgreSQL.js":118,"./providers/Meadow-Provider-RocksDB.js":119,"./providers/Meadow-Provider-SQLite.js":120,"./providers/Meadow-Provider-Solr.js":121,foxhound:46}],104:[function(e,t,r){
/**
* @license MIT
* @author <steven@velozo.com>
*/
